...
public interface ComunidadRepository extends Neo4jRepository<Comunidad, Long> {
    ...
    @Query("MATCH (u:Usuario) WHERE id(u) = $idUsuario "+
        ...
        "RETURN c")
    Comunidad guardarComunidadYCreador(String nombre, String descripcion, int participantes, String ubicacion, boolean privada, Long idUsuario, LocalDateTime fechaCreacion);
