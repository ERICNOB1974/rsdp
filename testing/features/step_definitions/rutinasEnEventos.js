...
When('se buscan las sugerencias de rutinas basadas en eventos', function () {
    this.result = httpRequest('GET', encodeURI(`http://backend:8080/rutinas/sugerenciasDeRutinasBasadasEnEventos/${this.nombreUsuario}`)).data;
...
Then('se espera que las sugerencias de rutinas basadas en eventos sean', function (recomendacionesRutinasString) {
