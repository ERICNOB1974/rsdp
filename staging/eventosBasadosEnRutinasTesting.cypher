...
(evento5:Evento { id: 2005, nombre: 'Calistenia inicial', fechaHora: datetime('2024-09-20T07:00:00'), descripcion: 'Calistenia principiante.', esPrivadoParaLaComunidad: false }),
(evento6:Evento { id: 2006, nombre: 'Calistenia avanzada', fechaHora: datetime('2024-09-25T07:00:00'), descripcion: 'Calistenia avanzado', esPrivadoParaLaComunidad: false });
...
(rutina5:Rutina { id: 2715 }), (rutina6:Rutina {id: 2716}),(rutina7:Rutina {id: 2717}),
...
MATCH (lucas:Usuario { nombreUsuario: 'lucas123' }), (eric:Usuario {nombreUsuario: 'eric456'}), (facundo:Usuario {nombreUsuario: 'facundo789'}), (pepe:Usuario {nombreUsuario:'pepe'}), (juan:Usuario {nombreUsuario:'juan'}),
(rutina1:Rutina { id: 2711 }), (rutina2:Rutina {id: 2712}), (rutina3:Rutina {id: 2713}), (rutina4:Rutina {id: 2714}),(rutina5:Rutina { id: 2715 }), (rutina6:Rutina {id: 2716}), (rutina7:Rutina {id: 2717})
...
MATCH (evento1:Evento { id: 2001 }), (evento2:Evento {id: 2002}), (evento3:Evento {id: 2003}), (evento4:Evento {id: 2004}),(evento6:Evento {id: 2006}),(evento5:Evento {id: 2005}),
(etiquetaCardio:Etiqueta { nombre: 'Cardio' }), (etiquetaYoga:Etiqueta {nombre: 'Yoga'}),
(etiquetaFuerza:Etiqueta { nombre: 'Fuerza' }), (etiquetaFuncional:Etiqueta {nombre: 'Funcional'}),
(etiquetaAvanzada:Etiqueta { nombre: 'Avanzada' }), (etiquetaFlexiones:Etiqueta { nombre: 'Flexiones' }) 
