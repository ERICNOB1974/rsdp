...
CREATE (lucas:Usuario {nombreUsuario: 'lucas', nombreReal: 'Usuario '})
CREATE (juan:Usuario {nombreUsuario: 'juan', nombreReal: 'Miembro '})
CREATE (marcos:Usuario {nombreUsuario: 'marcos', nombreReal: 'Miembro '})
CREATE (joaquin:Usuario {nombreUsuario: 'joaquin', nombreReal: 'Miembro'})

CREATE (comu1:Comunidad {nombre: 'Comunidad 1', descripcion: 'Comunidad'})
CREATE (comu2:Comunidad {nombre: 'comunidad 2', descripcion: 'Comunidad'})
CREATE (comu3:Comunidad {nombre: 'comunidad 3', descripcion: 'Comunidad'})
