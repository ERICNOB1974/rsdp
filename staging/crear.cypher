...
WITH c, [x IN etiquetas WHERE rand() < 0.2][0..2] AS etiquetasSeleccionadas
// Crear relaciones
...
// Seleccionar 2 etiquetas aleatorias
WITH ev, [x IN etiquetas WHERE rand() < 0.2][0..2] AS etiquetasSeleccionadas
// Crear relaciones
UNWIND etiquetasSeleccionadas AS etiqueta
...
WITH r, [x IN posiblesEjercicios WHERE rand() < 0.5] AS ejerciciosSeleccionados
